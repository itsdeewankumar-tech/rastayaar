  ...
  head: () => ({
    meta: [
...

      {
        ...
        content: "leg5CZ0EEN2Fos2z0XcnI5T6-EK3KBfoc2GV6Ovqwao",
      },
      ...
      { title: "RastaYaar — Karachi Public Transport, Bus Routes & Stops" },
      {
        name: "description",
        content:
          "Search Karachi bus routes, stops and fares across mini buses, coaches, Red Bus, EV Bus and BRT lines.",
      },
      { name: "author", content: "RastaYaar" },
